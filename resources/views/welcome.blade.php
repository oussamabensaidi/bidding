...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            <button id="theme-toggle" class="fixed top-4 right-4 z-50 p-2 rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                <svg id="theme-icon" class="w-6 h-6 text-gray-800 dark:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path id="theme-icon-path" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707"/>
                </svg>
            </button>
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#9B59B6] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <!-- Updated Logo Text -->
                            <h1 class="text-3xl font-bold text-[#9B59B6]">Bidding Platform</h1>
                        </div>
                    </header>
    
                    <main class="mt-6">
                        <div class="text-center mb-12">
                            <h2 class="text-4xl font-bold mb-4">Welcome to Our Auction Platform</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-400">Join our community of bidders and sellers</p>
                        </div>
    
                        <div class="grid gap-8 lg:grid-cols-2 mb-12">
                            <!-- Admin Role Card -->
                            <div class="p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                                <h3 class="text-2xl font-bold mb-4 text-[#9B59B6]">Admin Role</h3>
                                <p class="text-gray-600 dark:text-gray-300">
                                    Administrators can create new auction items and monitor bidding activity.
                                    Manage your listings and track all bids in real-time.
                                </p>
                            </div>
    
                            <!-- Client Role Card -->
                            <div class="p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                                <h3 class="text-2xl font-bold mb-4 text-[#9B59B6]">Client Role</h3>
                                <p class="text-gray-600 dark:text-gray-300">
                                    Participate in exciting auctions by placing bids on items you love.
                                    Find unique items and compete with other bidders to win!
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="mb-6 text-gray-600 dark:text-gray-400">Register now to access all platform features</p>
                            <div class="flex justify-center gap-4">
                                @if (Route::has('login'))
                               
                                    @auth
                                        <a href="{{ url('/dashboard') }}" class="bg-[#e74c3c] text-white px-8 py-3 rounded-lg hover:bg-[#e74c3c]/90 transition-colors">
                                            Click here to go to the dashboard
                                        </a>
                                    @else
                                    <a href="{{ route('login') }}" class="bg-[#3498db] text-white px-8 py-3 rounded-lg hover:bg-[#3498db]/90 transition-colors">
                                        Sign In
                                    </a>
        
                                        @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="bg-[#2ecc71] text-white px-8 py-3 rounded-lg hover:bg-[#2ecc71]/90 transition-colors">
                                            Create Account
                                        </a>
                                        @endif
                                    @endauth
    ...
    <script>
        ...
        function updateIcon(theme) {
            if (theme === 'dark') {
                ...
                themeIconPath.setAttribute('d', 'M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707');
            }
        }
    </script>
</html>
