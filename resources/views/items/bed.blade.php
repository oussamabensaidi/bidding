<x-app-layout>
    {{-- <div class="container mx-auto px-4 py-8">
        ...
        <div class="item-section mb-8">
            <h2 class="text-2xl font-semibold mb-4">Item</h2>
            <!-- Display item details here -->
            <p class="text-gray-700">Item details go here...</p>
        </div>
        
        <div class="people-live-section mb-8">
            <h2 class="text-2xl font-semibold mb-4">People Live</h2>
            <!-- Display people live details here -->
            <p class="text-gray-700">People live details go here...</p>
        </div>
        
        <div class="comment-section">
            <h2 class="text-2xl font-semibold mb-4">Comments</h2>
            <!-- Display comments here -->
            <p class="text-gray-700">Comments go here...</p>
        </div>
    </div>
</x-app-layout> --}}
